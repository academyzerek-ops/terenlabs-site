    ...
    <>
      ...
      <Container className="max-w-3xl py-16">
        ...
        <div className="mt-10 space-y-10">
          ...
          <Sec n="2" t="Что мы предоставляем">
            <p>
              ...
              ИИ-консультанта и инструменты финансовых расчётов (в т.ч. платные). Все материалы и
              расчёты носят <strong>информационно-аналитический и образовательный характер</strong>.
            </p>
          </Sec>
        ...
        <p className="text-sm leading-relaxed text-muted">
          Соглашение действует с июля 2026 года. Документ носит информационный характер; при
