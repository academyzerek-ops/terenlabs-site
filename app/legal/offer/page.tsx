...
// под дизайн сайта. Редакция сентября 2026: §2 и §6 — вся линейка бесплатна,
// платных продуктов нет (финмодели сняты с прода 09.09.2026) — terms.html нужно
// подтянуть к этой версии.
    ...
    <>
      ...
      <Container className="max-w-3xl border-t border-line pb-10 sm:pb-20 pt-6 sm:pt-10">
        ...
        <div className="mt-6 sm:mt-10 space-y-8">
          ...
          <Sec n="6" t="Стоимость">
            <p>
              Вся линейка TerenLabs — Академия, тесты, кейсы, обзоры ниш, ИИ-акулёнок —
              предоставляется бесплатно. Платных продуктов на сервисе нет. Если они появятся,
              условия, стоимость и порядок оплаты будут опубликованы отдельно до начала оплаты.
              По вопросам напишите через{" "}
