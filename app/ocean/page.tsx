...
// композит = сумма СРЕДНИХ по тестам уровня (Краб t1-t3, Барракуда 4 дисциплины
// + бонусный универсальный, Дельфин/Акула — открытые кейсы); пороги 7/10 (crab-t3 — 6).
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="card-premium h-full p-7">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted">
                ...
                не красят. У Краба три теста, у Барракуды четыре дисциплины
                (плюс бонусный универсальный), дальше — открытые кейсы, которые
                оценивает TEREN-AI. Порог сдачи — 7 из 10 (Краб·Универсальный — 6).
              </p>
            </div>
            </Reveal>
            <Reveal delay={260}>
