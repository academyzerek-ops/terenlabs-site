      ...
      <section className="border-t border-line">
        <Container className="py-16">
          ...
          <div className="mt-6 max-w-[860px]">
            {[
              ["Очки места", "Место в таблице считается по среднему баллу попыток, умноженному на коэффициент темпа: чем быстрее верные ответы, тем выше место. Отвечать наугад быстрее 5 секунд бессмысленно, антифрод-пол выравнивает спринтеров. В самой таблице показан не этот балл, а композит уровня."],
