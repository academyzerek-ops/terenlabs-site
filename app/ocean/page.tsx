      ...
      <section className="border-b border-line">
        <Container className="py-14 sm:py-20">
          ...
          <p className="mt-4 max-w-[62ch] text-[15px] leading-relaxed text-text-2">
            ...
            мысли. Сравнивай себя со всеми, с земляками по своему региону и внутри
            своего уровня.
          </p>
        </Container>
      </section>
      ...
      <section className="border-t border-line">
        <Container className="py-9 sm:py-16">
          ...
          <div className="mt-6 max-w-[860px]">
            {[
              ["Баллы", "Место в таблице считается по среднему баллу попыток, умноженному на коэффициент темпа: чем быстрее верные ответы, тем выше место. Отвечать наугад быстрее 5 секунд бессмысленно, антифрод-пол выравнивает спринтеров. В самой таблице показан не этот балл, а композит уровня."],
              ["Композит уровня", "Сумма средних баллов по тестам уровня. У Краба три теста, у Барракуды пять, дальше открытые кейсы, которые оценивает ИИ-акулёнок. Порог сдачи 7 из 10 (Краб · Универсальный: 6)."],
          ...
          <div className="mt-6 sm:mt-10 flex flex-col gap-4 rounded-[8px] border border-line bg-subtle p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-[14px] text-text-2">
                Войди, и попытки идут в зачёт. Аккаунт один: сайт и приложение видят один прогресс.
              </p>
            </div>
