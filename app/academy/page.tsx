...
export const metadata = pageMetadata({
  title: "Академия",
  description:
    "Академия TerenLabs: треки для малого бизнеса и трек для проекта на рост. Короткие главы, реальные цифры, тесты на ранг в Океане.",
  path: "/academy",
});
...
const GROUPS = [
  {
    ...
    title: "Своё дело",
    href: "/delo",
    desc: "Точка, мастер, магазин. Деньги, модели, маркетинг, люди и право малого бизнеса, в тенге.",
  },
  {
