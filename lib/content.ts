...
// Наш ответ: чему учим — универсалы, своё дело, реальность Казахстана (решение Адиля 2026-06-11)
export const STEPS = [
  {
    n: "01",
  ...
  {
    n: "02",
    title: "Упор на своё дело",
    desc: "Все начинают с малого. Своё дело — та каша, в которой универсал и закаляется: тут нет отделов, есть ты и твои решения.",
