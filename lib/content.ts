...
// Баннер-цифры (доказательства в тоне Ноа) — на навы-фоне
export const PROOF_STATS = [
  { value: "−1.4 млн ₸", label: "типичная цена ошибки, которую ловит финмодель до открытия" },
  { value: "42", label: "вопроса в тесте, которые нельзя угадать — только понять" },
  { value: "6", label: "уровней «Океан» — от Ракушки до Акулы бизнеса" },
];
