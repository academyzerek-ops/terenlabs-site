...
// Наш ответ: три «вместо» — философия, не фичи (арт тематический, не персонажи)
export const STEPS = [
  { n: "01", title: "Реализм — вместо мотивации", desc: "Цифры из БНС, НБРК и 2GIS. Мотивационных историй здесь не будет.", img: "/lessons/fund_m3-ch05_prism-three-views.jpg" },
  { n: "02", title: "Риски — вместо «успешного успеха»", desc: "Где утекут деньги и время — видно до того, как ты вложился.", img: "/lessons/fund_m6-ch02_risk-vs-fog.jpg" },
  { n: "03", title: "Математика — вместо красивых историй", desc: "Точка безубыточности, сезонность, кассовый разрыв — в Excel, а не в слайдах.", img: "/lessons/arch_m4-ch00_drill-hole.jpg" },
];
