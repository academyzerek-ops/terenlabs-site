...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    rule: "3 открытых кейса по 5 вопросов. Ответ разбирает ИИ-акулёнок.",
...
const HOW = [
  ...
  "Закрытые тесты Океана: 10 вопросов, вопросы каждый раз новые. Балл считает сервер, правильных ответов в браузере нет.",
  "Открытые кейсы Дельфина и Акулы: отвечаешь своими словами, проверяет ИИ-акулёнок по рубрике.",
  "Не сдал — пересдавай сразу, сколько нужно: выборка вопросов будет другой. Сданное идёт в ранг и в рейтинг.",
];
