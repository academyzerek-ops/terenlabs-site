...
// Счётчик Яндекс.Метрики terenlabs.kz (аккаунт paidaagency). Карта кликов и скроллинга включена.
// Вебвизор выключен (решение Адиля 13.09.2026): записи экрана, в том числе подростков, —
// риск без пользы для учёбы; учебные события пишет свой трекер.
